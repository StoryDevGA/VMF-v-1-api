...
export const RUNTIME_PATH_REGISTRY_SOURCE_TYPES = Object.freeze({
  ...
  CUSTOMER_RUNTIME_STATE: 'CUSTOMER_RUNTIME_STATE',
  GENERATED_ADVISOR_STATE: 'GENERATED_ADVISOR_STATE',
  GENERATED_RUNTIME_STATE: 'GENERATED_RUNTIME_STATE',
  OUTCOME_RUNTIME_STATE: 'OUTCOME_RUNTIME_STATE',
  SNAPSHOT: 'SNAPSHOT',
...
export const RUNTIME_PATH_REGISTRY_SECTION_BINDING_CATEGORIES = Object.freeze([
  RUNTIME_PATH_REGISTRY_CATEGORIES.SECTION,
  RUNTIME_PATH_REGISTRY_CATEGORIES.CUSTOMER_KNOWLEDGE,
  RUNTIME_PATH_REGISTRY_CATEGORIES.OUTCOME,
  RUNTIME_PATH_REGISTRY_CATEGORIES.RUNTIME_INTELLIGENCE,
])
